...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://arsen:2nN5WxSjQwg6tHbPzTAn3xyJyy3TMVpU@dpg-cp2v4sm3e1ms73f6j540-a:5432/epltable?sslmode=disable", "PostgreSQL DSN")
	flag.Parse()
